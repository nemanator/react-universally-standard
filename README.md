<p align='center'>
  <h1 align='center'>React, Universally - Standard</h1>
  <p align='center'><img width='150' src='https://raw.githubusercontent.com/ctrlplusb/assets/master/logos/react-universally.png' /></p>
  <p align='center'><img width='150' src='https://cdn.rawgit.com/feross/standard/master/badge.svg' /></p>
  <p align='center'>A starter kit giving you the minimum requirements for a modern universal React application.</p>
</p>

## About

This is a fork of the [React, Universally](https://github.com/ctrlplusb/react-universally) project. The only difference is that this uses Standard ESLint instead of Airbnb.
...
```bash
git clone https://github.com/rlindskog/react-universally-standard my-project
cd my-project
npm run development
```
